...
@RestController
@RequestMapping("/ucenterservice/upload")
public class UcenterFileUploadController {
    ...
    public String uploadParttimeImg(@RequestBody MultipartFile file) throws IOException {//MultipartFile 接收前端传过来的文件
        ...
        String path="D:\\VScode\\vue-admin-template-master\\vue-admin-10\\src\\static\\img\\userAvatar\\";//指定上传路径
