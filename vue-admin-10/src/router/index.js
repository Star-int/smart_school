...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '智慧校园后台首页', icon: 'dashboard' }
    }]
  },
  ...
  //   name: '兼职管理',
  //   meta: { title: '兼职管理', icon: 'example' },
  //   children:[
      
  //     {
  //       path: 'edit/:id',
  //       name: '编辑招聘',
  //       component: () => import('@/views/recruit/recruitment/save'),
  //       meta: { title: '兼职编辑', icon: 'table' },
  ...
  {  
    ...
    children:[
      ...
      
      {
        path: 'save',
        name: '添加兼职',
        component: () => import('@/views/recruit/parttime/save'),
        meta: { title: '添加兼职', icon: 'table' }
